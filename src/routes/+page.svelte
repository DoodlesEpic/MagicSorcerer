...
<main class="container mt-5">
	<section class="mb-3">
		<p>
			Welcome to Magic the Gathering Sorcerer. The website uses AI to provide suggestions to help
			you improve your Magic: The Gathering decklists. Whether you're a seasoned pro or a newcomer
			to the game, our AI can help you identify combos, understand your deck's strengths and
			weaknesses, and make informed decisions about which cards to add or remove. Our user-friendly
			interface and accessible language make it easy for any Magic player to benefit from our AI's
			expert insights.
		</p>
		<ul>
			<li>Ada: A state-of-the-art language model that can generate human-like text.</li>
			<li>
				Babbage: A language model that can answer questions and provide information on a wide range
				of topics.
			</li>
			<li>
